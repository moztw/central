...
謝謝您的耐心。
<!-- Search Google -->
<form id=\"google\" method=\"get\" action=\"http:
...
<input type=hidden name=\"cof\" value=\"LW:135;L:http:
...
'nstab-wp' => "關於", 
'portal' => "社區",
'prefs-help-userdata' => "*<strong>真實姓名</strong>（可選）：用以對您的貢獻署名。<br />*<strong>電子郵件</strong>（可選）：讓他人通過網站在不知道您的電子郵件地址的情況下通過電子郵件與您聯絡，以及通過電子郵件取得遺忘的密碼。", 
'prefs-misc' => "雜項", 
'prefs-personal' => "用戶數據",
'prefs-rc' => "最近更新", 
