...
define('AUTO_WVT_MOD', false);    	// Who viewed a topic [2.0.6/EM]
...
define('AUTOLOGIN',false);			// Try to autologin using cookie if user not set 'login' or 'uid' key
define('SEE_MODIFYED',false);		// Include in feed modified from last visit record in addition to new records
