        ...
        <tr valign="bottom">
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="bottom"><div align="left">&nbsp;<span class="genmed"><strong>{L_TOPIC_REVIEW}</strong></span></div></td>
              </tr>
          </table></td>
        </tr>
        <tr>
          ...
          <td width="98%" height="28" valign="bottom" class="stil06">
            <table width="99%" height="20"  border="0" align="center" cellpadding="0" cellspacing="0">
              <tr>
                <td><span class="postdetails">{L_POSTED}: {POST_DATE}</span></td>
              </tr>
          </table></td>
          <td width="1%" rowspan="2" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
...
<table border="0" cellpadding="2" cellspacing="1" width="100%" class="forumline">
	...
	<tr>
		...
		<td class="{postrow.ROW_CLASS}" height="28" valign="top"><table width="100%" border="0" cellspacing="0" cellpadding="0">
			<tr> 
				<td width="100%"><span class="postdetails">{L_POSTED}: {postrow.POST_DATE}</span></td>
			</tr>
			<tr> 
				<td colspan="2"><hr /></td>
			</tr>
	...
	<tr> 
		<td colspan="2" height="1" class="spaceRow"><img src="templates/LiteVision/images/spacer.gif" alt="" width="1" height="1" /></td>
	</tr>
	 <!-- END postrow -->
</table>
<!-- BEGIN switch_inline_mode -->
