      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
        ...
        <tr>
          ...
          <td width="98%" bgcolor="#EAF1FC"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td><div align="justify"><span class="gensmall">{L_STYLES_ADD_TEXT}</span></div></td>
            </tr>
          </table></td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
	<tr valign="bottom">
		<td height="26" class="stil06"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="center"><span class="gensmall"><strong>{L_STYLE}</strong></span></div></td>
          </tr>
        </table></td>
		<td height="26" class="stil06"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="center"><span class="gensmall"><strong>{L_TEMPLATE}</strong></span></div></td>
          </tr>
        </table></td>
		<td height="26" class="stil06"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0">
          <tr>
            <td><div align="center"><span class="gensmall"><strong>{L_ACTION}</strong></span></div></td>
          </tr>
        </table></td>
	</tr>
	<!-- BEGIN styles -->
	<tr>
		...
		<td bgcolor="#E1ECFB"><div align="center"><span class="gensmall"><a href="{styles.U_STYLES_INSTALL}">{L_INSTALL}</a></span></div></td>
	</tr>
	<!-- END styles -->
</table></form>		  </td>
        </tr>
