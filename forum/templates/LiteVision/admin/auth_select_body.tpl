        ...
        <tr valign="bottom">
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top"><div align="center"><span class="gensmall"><strong>{L_AUTH_SELECT}</strong></span></div></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
...
<table width="100%" height="22" border="0" align="center" cellpadding="0" cellspacing="0">
	<tr>
		<td bgcolor="#E1ECFB" align="center">{S_HIDDEN_FIELDS}{S_AUTH_SELECT}&nbsp;&nbsp;<input type="submit" value="{L_LOOK_UP}" class="form2" />&nbsp;</td>
	</tr>
</table>
		  </td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
