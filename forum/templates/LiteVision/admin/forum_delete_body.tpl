      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
          ...
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top"><div align="center"><span class="gensmall"><strong>{L_FORUM_DELETE}</strong></span></div></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
        ...
        <tr>
          ...
          <td width="98%" bgcolor="#EAF1FC"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td><div align="justify"><span class="gensmall">{L_FORUM_DELETE_EXPLAIN}</span></div></td>
            </tr>
          </table></td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
        ...
        <tr>
          ...
          <td width="98%"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <td width="50%" bgcolor="#E1ECFB"><div align="center"><span class="gensmall">{L_FORUM_NAME}</span></div></td>
              <td width="50%" bgcolor="#E1ECFB"><div align="center"><span class="gensmall">{NAME}</span></div></td>
            </tr>
            <tr>
              <td width="50%" bgcolor="#EAF1FC"><div align="center"><span class="gensmall">{L_MOVE_CONTENTS}</span></div></td>
              <td width="50%" bgcolor="#EAF1FC"><div align="center"><span class="gensmall">{S_SELECT_TO}</span></div></td>
            </tr>
            <tr>
