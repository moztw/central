      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
        ...
        <tr>
          ...
          <td width="98%" bgcolor="#EAF1FC"><table width="98%"  border="0" align="center" cellpadding="0" cellspacing="2">
            <tr>
              <td><div align="justify"><span class="gensmall">{L_PRUNE_RESULT}</span></div></td>
            </tr>
          </table></td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
        </tr>
      ...
      <table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
        <tr valign="bottom">
          <td height="26" colspan="3" class="stil01"><table width="100%" height="20"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
              <tr>
                ...
                <td width="95%" valign="bottom"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
                  <tr>
                    <td valign="top"><span class="gensmall"><strong>{L_FORUM_PRUNE}</strong></span></td>
                  </tr>
                </table></td>
              </tr>
          </table></td>
        ...
        <tr>
          ...
          <td width="98%"><table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
            <tr>
              <th height="28" valign="bottom" class="stil06"><table width="100%" height="18"  border="0" cellpadding="0" cellspacing="0">
                <tr>
              ...
              <th height="28" valign="bottom" class="stil06"><table width="100%" height="18"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top"><div align="center"><span class="gensmall"><strong>{L_TOPICS_PRUNED}</strong></span></div></td>
                </tr>
              </table></th>
              <th height="28" valign="bottom" class="stil06"><table width="100%" height="18"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td valign="top"><div align="center"><span class="gensmall"><strong>{L_POSTS_PRUNED}</strong></span></div></td>
                </tr>
              </table></th>
            </tr>
            <!-- BEGIN prune_results -->
            <tr>
              <td bgcolor="#E1ECFB" align="center"><span class="gensmall">{prune_results.FORUM_NAME}</span></td>
              <td bgcolor="#EAF1FC" align="center"><span class="gensmall">{prune_results.FORUM_TOPICS}</span></td>
              <td bgcolor="#E1ECFB" align="center"><span class="gensmall">{prune_results.FORUM_POSTS}</span></td>
            </tr>
            <!-- END prune_results -->
          </table></td>
          <td width="1%" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
