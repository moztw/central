...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
  <tr valign="bottom">
    <td height="26" colspan="3" class="stil01"><table width="100%" height="18"  border="0" cellpadding="0" cellspacing="0" class="border-maro-dr">
      <tr>
        <td width="5%" valign="bottom"><img src="templates/LiteVision/images/05.gif" width="49" height="21"></td>
        <td width="95%" valign="top"><div align="left">&nbsp;&nbsp;<a href="{U_INDEX}" class="nav">{L_INDEX}</a></div></td>
  ...
  <tr>
	...
	<table width="99%" height="20"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><div align="center"><span class="genmed"><strong>{L_ENTER_PASSWORD}</strong></span></div></td>
        </tr>
    </table></td>
    <td width="1%" rowspan="2" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
  </tr>
...
<table border="0" cellpadding="3" cellspacing="1" width="100%">
		  ...
		  <tr> 
			...
			<td> 
			  <input type="text" name="username" size="25" maxlength="40" class="form" value="{USERNAME}" />
			</td>
		  </tr>
		  <tr> 
			<td align="right"><span class="gen">{L_PASSWORD}:</span></td>
			<td> 
			  <input type="password" name="password" size="25" class="form" maxlength="32" />
			</td>
		  </tr>
		  <tr align="center"> 
