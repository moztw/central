	<tr>
		<td class="stil06" colspan="2" style='text-align: center; font-weight: bold;'><span class='genmed'>{L_ADD_ATTACH_TITLE}</span></th>
	</tr>
	<tr>
	...
	<tr>
<td class="stil06" colspan="2" style='text-align: center; font-weight: bold;'>&nbsp;</th>
	</tr>
