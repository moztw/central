...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
  ...
  <tr>
	...
	<table width="99%" height="22"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td><div align="center"><span class="genmed"><strong>{L_VIEWING_PROFILE}</strong></span></div></td>
        </tr>
    </table></td>
    <td width="1%" rowspan="2" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
  </tr>
	  ...
	  <table width="100%"  border="0" align="center" cellpadding="0" cellspacing="2">
        <tr>
          <td><table width="100%" cellspacing="0" cellpadding="0" border="0" align="center">
            <tr>
              <td colspan="2" height="25"><table width="100%" height="28"  border="0" cellpadding="0" cellspacing="0">
                <tr>
                  <td width="50%" class="stil01"><div align="left">&nbsp;&nbsp;<span class="genmed"><strong>{L_AVATAR}</strong></span></div></td>
                  <td width="50%" class="stil01"><div align="right"><span class="genmed"><strong>{L_ABOUT_USER}</strong></span>&nbsp;&nbsp;</div></td>
                </tr>
              </table></td>
            </tr>
            <tr>
              <td width="40%" align="center" valign="top" bgcolor="#EAF1FC">{AVATAR_IMG}<br />
                  <span class="postdetails">{POSTER_RANK}</span></td>
              <td width="60%" rowspan="3" valign="top" bgcolor="#EAF1FC"><table width="99%" border="0" align="center" cellpadding="3" cellspacing="1" bgcolor="#E1ECFB" class="border-bleu">
                  <tr>
...
<!-- END switch_upload_limits -->
            ...
            <tr>
              <td class="stil06" align="center" height="20"><b><span class="gen">{L_CONTACT} {USERNAME} </span></b></td>
            </tr>
            <tr>
              <td bgcolor="#EAF1FC" valign="top"><table width="100%" border="0" cellspacing="2" cellpadding="2">
                  <tr>
