...
<table width="100%"  border="0" cellpadding="0" cellspacing="0" class="border-bleu-jos">
  ...
  <tr>
    ...
    <td width="98%" height="25" valign="bottom" class="stil06"><table width="99%" height="18"  border="0" align="center" cellpadding="0" cellspacing="0">
      <tr>
        <td valign="middle"><div align="center"><span class="genmed"><strong>{L_IP_INFO}</strong></span></div></td>
      </tr>
    </table></td>
    <td width="1%" rowspan="2" bgcolor="#D0E4FB" class="border-bleu-st-dr">&nbsp;</td>
  </tr>
...
<table width="100%" border="0" align="center" cellpadding="0" cellspacing="1">
  <tr> 
	<td bgcolor="#E1ECFB" height="28"><span class="genmed"><strong>&nbsp;{L_THIS_POST_IP}</strong></span></td>
  </tr>
  <tr> 
	<td bgcolor="#F4F8FD"> 
  ...
  <tr> 
	<td bgcolor="#E1ECFB" height="28"><span class="genmed"><strong>&nbsp;{L_OTHER_USERS}</strong></span></td>
  </tr>
  <!-- BEGIN userrow -->
  <tr> 
	<td bgcolor="#F4F8FD"> 
  ...
  <!-- END userrow -->
  <tr> 
	<td bgcolor="#E1ECFB" height="28"><span class="genmed"><strong>&nbsp;{L_OTHER_IPS}</strong></span></td>
  </tr>
  <!-- BEGIN iprow -->
  <tr> 
	<td bgcolor="#F4F8FD"><table width="100%" cellspacing="0" cellpadding="0" border="0">
		<tr> 
