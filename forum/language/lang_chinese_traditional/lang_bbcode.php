...
$faq[] = array("如何製作單行間距的文字", " 有特定的 BBCode 讓你在你的文字中使用單行間距的樣式. 就如下方的例子: <ul><li>要製作一段單行間距的文字，將它放在 <b>[tt][/tt]</b>, 例如：<br /><b>[tt]</b>單行間距的文字<b>[/tt]</b><br />就會變成 <tt>單行間距的文字</tt><br /><small>(from <a href=\"http://sillydog.org/forum/\">SillyDog701 Message Centre</a>)</small></li></ul>");
