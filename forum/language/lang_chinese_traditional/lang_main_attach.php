...
$lang['Attach_posting_cp_explain'] = '如果您點選「新增附加檔案或貼圖」，您將可附上小檔案或說明用的圖片。<br />若有「發表的附加檔案清單」選項則可更新已傳檔案、上傳新的版本(下載次數不會歸零)。<br />';
//要更如何上傳新版本檔案，先點選「發表的附加檔案清單」，再點選「新增附加檔案」，再點[新增附加檔案]中的「瀏覽」，<br />選擇新版本的檔案之後，再點選[發表的附加檔案清單]中的「上傳新的版本」。'
