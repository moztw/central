...
$faq[] = array("How to create monospaced text (teletype text)", "MozTW Forum has unique BBCode that allows you to have monospaced style in your text. This is as following: <ul><li>To make a piece of text monospaced enclose it in <b>[tt][/tt]</b>, eg. <br /><b>[tt]</b>Monospaced text<b>[/tt]</b><br />will become <tt>Monospaced text</tt><br /><small>(from <a href=\"http://sillydog.org/forum/\">SillyDog701 Message Centre</a>)</small></li></ul>");
