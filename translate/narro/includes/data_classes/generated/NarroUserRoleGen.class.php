<?php
	 ...
	 * 
	 */
	class NarroUserRoleGen extends QBaseClass {
		///////////////////////////////
		// COMMON LOAD METHODS
		///////////////////////////////
		 ...
		 */
		public static function Load($intUserRoleId) {
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder->AddFromItem('`narro_user_role` AS `narro_user_role`');
		...
		/**
		 * Static Qcodo Query method to query for a single NarroUserRole object.
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			return NarroUserRole::InstantiateDbRow($objDbResult->GetNextRow());
		}

		/**
		 * Static Qcodo Query method to query for an array of NarroUserRole objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return NarroUserRole::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes);
		}

		/**
		 * Static Qcodo Query method to query for a count of NarroUserRole objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
			...
			$objCache = new QCache('query', 'narro_user_role_' . serialize($strConditions));
			if (!($strQuery = $objCache->GetData())) {
				// Not Found -- Go ahead and Create/Build out a new QueryBuilder object with NarroUserRole-specific fields
				$objQueryBuilder = new QQueryBuilder($objDatabase);
				NarroUserRole::GetSelectFields($objQueryBuilder);
				NarroUserRole::GetFromFields($objQueryBuilder);
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null) {
			...
			$objBuilder->AddSelectItem($strTableName . '.`user_role_id` AS ' . $strAliasPrefix . 'user_role_id`');
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null) {
			...
			$objToReturn->intUserRoleId = $objDbRow->GetColumn($strAliasPrefix . 'user_role_id', 'Integer');
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null) {
			...
			if ($strExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NarroUserRole::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem);
					if ($objItem) {
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					array_push($objToReturn, NarroUserRole::InstantiateDbRow($objDbRow));
			}
		 ...
		 * @return NarroUserRole
		*/
		public static function LoadByUserRoleId($intUserRoleId) {
			return NarroUserRole::QuerySingle(
				QQ::Equal(QQN::NarroUserRole()->UserRoleId, $intUserRoleId)
			);
		}
		 ...
		 * @return NarroUserRole
		*/
		public static function LoadByUserIdRoleIdProjectIdLanguageId($intUserId, $intRoleId, $intProjectId, $intLanguageId) {
			return NarroUserRole::QuerySingle(
				QQ::AndCondition(
	...
	class QQNodeNarroUserRole extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				case 'UserRoleId':
					return new QQNode('user_role_id', 'integer', $this);
				case 'UserId':
