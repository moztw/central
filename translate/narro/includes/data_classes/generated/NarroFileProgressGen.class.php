<?php
	 ...
	 * 
	 */
	class NarroFileProgressGen extends QBaseClass {
		///////////////////////////////
		// COMMON LOAD METHODS
		///////////////////////////////
		 ...
		 */
		public static function Load($intFileProgressId) {
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder->AddFromItem('`narro_file_progress` AS `narro_file_progress`');
		...
		/**
		 * Static Qcodo Query method to query for a single NarroFileProgress object.
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			return NarroFileProgress::InstantiateDbRow($objDbResult->GetNextRow());
		}

		/**
		 * Static Qcodo Query method to query for an array of NarroFileProgress objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return NarroFileProgress::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes);
		}

		/**
		 * Static Qcodo Query method to query for a count of NarroFileProgress objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
			...
			$objCache = new QCache('query', 'narro_file_progress_' . serialize($strConditions));
			if (!($strQuery = $objCache->GetData())) {
				// Not Found -- Go ahead and Create/Build out a new QueryBuilder object with NarroFileProgress-specific fields
				$objQueryBuilder = new QQueryBuilder($objDatabase);
				NarroFileProgress::GetSelectFields($objQueryBuilder);
				NarroFileProgress::GetFromFields($objQueryBuilder);
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null) {
			...
			$objBuilder->AddSelectItem($strTableName . '.`file_progress_id` AS ' . $strAliasPrefix . 'file_progress_id`');
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null) {
			...
			$objToReturn->intFileProgressId = $objDbRow->GetColumn($strAliasPrefix . 'file_progress_id', 'Integer');
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null) {
			...
			if ($strExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NarroFileProgress::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem);
					if ($objItem) {
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					array_push($objToReturn, NarroFileProgress::InstantiateDbRow($objDbRow));
			}
		 ...
		 * @return NarroFileProgress
		*/
		public static function LoadByFileProgressId($intFileProgressId) {
			return NarroFileProgress::QuerySingle(
				QQ::Equal(QQN::NarroFileProgress()->FileProgressId, $intFileProgressId)
			);
		}
		 ...
		 * @return NarroFileProgress
		*/
		public static function LoadByFileIdLanguageId($intFileId, $intLanguageId) {
			return NarroFileProgress::QuerySingle(
				QQ::AndCondition(
	...
	class QQNodeNarroFileProgress extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				case 'FileProgressId':
					return new QQNode('file_progress_id', 'integer', $this);
				case 'FileId':
