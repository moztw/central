<?php
	 ...
	 * 
	 */
	class NarroTextCommentGen extends QBaseClass {
		///////////////////////////////
		// COMMON LOAD METHODS
		///////////////////////////////
		 ...
		 */
		public static function Load($intTextCommentId) {
		...
		protected static function BuildQueryStatement(&$objQueryBuilder, QQCondition $objConditions, $objOptionalClauses, $mixParameterArray, $blnCountOnly) {
			...
			$objQueryBuilder->AddFromItem('`narro_text_comment` AS `narro_text_comment`');
		...
		/**
		 * Static Qcodo Query method to query for a single NarroTextComment object.
		...
		public static function QuerySingle(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			return NarroTextComment::InstantiateDbRow($objDbResult->GetNextRow());
		}

		/**
		 * Static Qcodo Query method to query for an array of NarroTextComment objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
		...
		public static function QueryArray(QQCondition $objConditions, $objOptionalClauses = null, $mixParameterArray = null) {
			...
			$objDbResult = $objQueryBuilder->Database->Query($strQuery);
			return NarroTextComment::InstantiateDbResult($objDbResult, $objQueryBuilder->ExpandAsArrayNodes);
		}

		/**
		 * Static Qcodo Query method to query for a count of NarroTextComment objects.
		 * Uses BuildQueryStatment to perform most of the work.
		 * @param QQCondition $objConditions any conditions on the query, itself
		 * @param QQClause[] $objOptionalClausees additional optional QQClause objects for this query
		 * @param mixed[] $mixParameterArray a array of name-value pairs to perform PrepareStatement with
...
/*		public static function QueryArrayCached($strConditions, $mixParameterArray = null) {
			...
			$objCache = new QCache('query', 'narro_text_comment_' . serialize($strConditions));
			if (!($strQuery = $objCache->GetData())) {
				// Not Found -- Go ahead and Create/Build out a new QueryBuilder object with NarroTextComment-specific fields
				$objQueryBuilder = new QQueryBuilder($objDatabase);
				NarroTextComment::GetSelectFields($objQueryBuilder);
				NarroTextComment::GetFromFields($objQueryBuilder);
		...
		public static function GetSelectFields(QQueryBuilder $objBuilder, $strPrefix = null) {
			...
			$objBuilder->AddSelectItem($strTableName . '.`text_comment_id` AS ' . $strAliasPrefix . 'text_comment_id`');
		...
		*/
		public static function InstantiateDbRow($objDbRow, $strAliasPrefix = null, $strExpandAsArrayNodes = null, $objPreviousItem = null) {
			...
			$objToReturn->intTextCommentId = $objDbRow->GetColumn($strAliasPrefix . 'text_comment_id', 'Integer');
		...
		public static function InstantiateDbResult(QDatabaseResultBase $objDbResult, $strExpandAsArrayNodes = null) {
			...
			if ($strExpandAsArrayNodes) {
				...
				while ($objDbRow = $objDbResult->GetNextRow()) {
					$objItem = NarroTextComment::InstantiateDbRow($objDbRow, null, $strExpandAsArrayNodes, $objLastRowItem);
					if ($objItem) {
				...
				while ($objDbRow = $objDbResult->GetNextRow())
					array_push($objToReturn, NarroTextComment::InstantiateDbRow($objDbRow));
			}
		 ...
		 * @return NarroTextComment
		*/
		public static function LoadByTextCommentId($intTextCommentId) {
			return NarroTextComment::QuerySingle(
				QQ::Equal(QQN::NarroTextComment()->TextCommentId, $intTextCommentId)
			);
		}
		...
		/**
		 * Load a single NarroTextComment object,
		 * by TextId, UserId, CommentTextMd5 Index(es)
		 * @param integer $intTextId
		 * @param integer $intUserId
		 * @param string $strCommentTextMd5
		 * @return NarroTextComment
		*/
		public static function LoadByTextIdUserIdCommentTextMd5($intTextId, $intUserId, $strCommentTextMd5) {
			return NarroTextComment::QuerySingle(
				QQ::AndCondition(
	...
	class QQNodeNarroTextComment extends QQNode {
		...
		public function __get($strName) {
			switch ($strName) {
				case 'TextCommentId':
					return new QQNode('text_comment_id', 'integer', $this);
				case 'TextId':
