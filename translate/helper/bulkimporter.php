...
system('mysqldump -u ' . $DB['username'] . ' ' . $DB['database'] . ' > /home/moztw/translate/data/helper/narro-backup-$(date +%Y%m%d_%H%M%S)-$(head -c50 /dev/urandom | tr -dc A-Z-a-z-0-9 | head -c8).sql');
